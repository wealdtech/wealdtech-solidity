...
contract EmitMessage is ERC777TokensSender, ERC820Implementer {
     ...
     */
    function tokensToSend(address operator, address holder, address recipient, uint256 amount, bytes userData, bytes operatorData) public {
        (operator, amount, userData, operatorData);
