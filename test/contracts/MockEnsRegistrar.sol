...
contract Deed {
    ...
    function Deed(address _owner) payable public {
        owner = _owner;
...
contract MockEnsRegistrar {
    ...
    function MockEnsRegistrar(AbstractENS _ens, bytes32 _rootNode) public payable {
        ens = _ens;
        rootNode = _rootNode;
    }
    ...
    function transfer(bytes32 hash, address newOwner) public onlyOwner(hash) {
        require(newOwner != 0);
